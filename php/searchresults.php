...
if ($_POST)	{
	$searchquery = filter_input(INPUT_POST, 'search-input', FILTER_SANITIZE_STRING);
	$output = '';
	if(isset($_POST['search-input'])) {
		$searchquery = $_POST['search-input'];
    ...
    <body>
        <div class="navbar">
            <div class="navbar-wrapper">
				...
				<form enctype="multipart/form-data" id="searchForm" action="" method="POST" class ="search-bar">
        ...
        <div class="content">
            <p id="search-header">Showing search result for keyword "
                <span id="search-key">You</span>
                "
            </p>
            <p id="search-available"><span id="search-result">14</span> results available</p>
